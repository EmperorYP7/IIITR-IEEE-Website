...
export default function UploadPDF(props) {
    ...
    const onSubmit = async (e) => {
        ...
        formData.append('resource', state.file);
    ...
    return (
        <form onSubmit={onSubmit} encType="multipart/form-data" id='form'>
                <div className='custom-file upload-row row'>
                    <div className="col-9">
                        <input type="file" name="resource" required={true} onChange={changeHandler} placeholder="Upload PDF" className='custom-file-input' />
