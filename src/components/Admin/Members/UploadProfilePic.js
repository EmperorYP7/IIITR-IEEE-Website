...
export default function UploadProfilePic(props) {
    ...
    const onSubmit = async (e) => {
        ...
        formData.append('member', state.file);
    ...
    return (
        <form onSubmit={onSubmit} encType="multipart/form-data" id='form'>
                <div className='custom-file upload-row row'>
                    <div className="col-9">
                        <input type="file" name="member" required={true} onChange={changeHandler} placeholder="Upload Profile Pic" className='custom-file-input' />
