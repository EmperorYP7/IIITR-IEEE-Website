...
class Members extends React.Component {
    ...
    onMemberDelete = (member) => {
        axios.delete(`https://ieeemock2.azurewebsites.net/api/memberdata/${member._id}`)
            .then(res => {
                alert("Member Removed!");
                this.UpdateState();
            })
        axios.delete(`https://ieeemock2.azurewebsites.net/upload/image/member/${member.imgPath}`)
            .then(  res => {
